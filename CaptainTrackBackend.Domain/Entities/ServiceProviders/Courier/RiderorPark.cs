...
{
    public class RiderorPark : AuditableEntity
    {
        ...
        public Guid? CourierVehicleId { get; set; }
        public List<CourierVehicle> CourierVehicles { get; set; } = new List<CourierVehicle>();
    }
}
